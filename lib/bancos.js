...
const REGLAS = [
  ...
  [/afip|arca|vep |imp\.afip|plan ?rg/i, "Impuestos"],
  [/echeq|cheque/i, "Cheques a proveedores"],
  [/trf inmed proveed|transferencias cash proveedores|transferencia de terceros/i, "Proveedores"],
  [/payway|posnet|terminal|descuento de cupones/i, "Comisiones de tarjeta"],
  [/pago visa empresa|tarjeta/i, "Tarjeta corporativa"],
  [/imp\. ?deb\.|imp\. ?cre\.|ing\. ?brutos|percep|impuesto de sellos|sircreb|^iva$/i, "Impuestos y sellos bancarios"],
  [/comision|intereses|servicio de cuenta|com\. ?certif/i, "Gastos bancarios"],
  [/seguro|galicia seguros|smg|mercantil andina|federacion patro/i, "Seguros"],
  [/zoo logic|software|abono|personal|flow|telecom|claro|movistar/i, "Servicios y software"],
  [/faceb|meta ads/i, "Publicidad"],
  [/envío|envio|correo|dhl|andreani|oca/i, "Envíos"],
